...
final case class Game(
  ...
  processorMinimum: Option[String],
  processorRecommended: Option[String],
  graphicsMinimum: Option[String],
  graphicsRecommended: Option[String],
  ramMinimumGb: Option[Short],
  ramRecommendedGb: Option[Short],
  storageMinimumGb: Option[Short],
  storageRecommendedGb: Option[Short],
